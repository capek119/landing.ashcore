...
export default function App() {
  ...
  // Brand colors from ashcore.co.uk
  const colors = {
    cream: "#fdf8f3",
    creamDark: "#f5ebe0",
    orange: "#e07a3d",
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          >
            <span style={{ fontWeight: "600" }}>ash</span>core
          </span>
        </div>
            ...
            {tools.map((tool, index) => (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    hoveredTile === tool.id
                      ? "0 20px 40px -15px rgba(224, 122, 61, 0.2)"
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        a:hover { color: #e07a3d !important; }
      `}</style>
    </div>
  );
}
